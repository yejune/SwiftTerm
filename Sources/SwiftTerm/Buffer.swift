...
//                #endif
     ...
     */
    public var savedCharset: [UInt8: String]?
    ...
    var scroll: (_ isWrapped: Bool) -> Void = { _ in
    ...
    public init (cols: Int, rows: Int, tabStopWidth: Int, scrollback: Int?) {
        ...
        _lines.makeEmpty = { [unowned self] _ in getBlankLine(attribute: CharData.defaultAttr, isWrapped: false) }
        setupLinesCallbacks()
    ...
    func reflowWider(_ oldCols: Int, _ oldRows: Int, _ newCols: Int, _ newRows: Int) {
        ...
        if toRemove.count > 0 {
            ...
            newLayoutLines.makeEmpty = { [unowned self] _ in getBlankLine(attribute: CharData.defaultAttr, isWrapped: false) }
